...
ann11 = Annotation.create!(anno_body: "Judge me by my size, do you?", author_id: 11, track_id: 11, start_idx: 105, end_idx: 290)
ann12 = Annotation.create!(anno_body: "Wars not make one great.", author_id: 12, track_id: 12, start_idx: 105, end_idx: 290)
ann13 = Annotation.create!(anno_body: "Clear your mind must be, if you are to find the villains behind this plot.", author_id: 13, track_id: 13, start_idx: 105, end_idx: 290)
ann14 = Annotation.create!(anno_body: "Always two there are, no more, no less. A master and an apprentice.", author_id: 14, track_id: 14, start_idx: 105, end_idx: 290)
ann15 = Annotation.create!(anno_body: "Always pass on what you have learned.", author_id: 15, track_id: 15, start_idx: 105, end_idx: 290)
ann16 = Annotation.create!(anno_body: "Mind what you have learned. Save you it can.", author_id: 16, track_id: 16, start_idx: 105, end_idx: 290)
ann17 = Annotation.create!(anno_body: "To answer power with power, the Jedi way this is not.", author_id: 17, track_id: 17, start_idx: 105, end_idx: 290)
ann18 = Annotation.create!(anno_body: "In this war, a danger there is, of losing who we are.", author_id: 18, track_id: 18, start_idx: 105, end_idx: 290)
ann19 = Annotation.create!(anno_body: "Attachment leads to jealously. The shadow of greed, that is.", author_id: 19, track_id: 19, start_idx: 105, end_idx: 290)
ann20 = Annotation.create!(anno_body: "In the end, cowards are those who follow the dark side.", author_id: 20, track_id: 20, start_idx: 105, end_idx: 290)
ann21 = Annotation.create!(anno_body: "So certain were you. Go back and closer you must look.", author_id: 21, track_id: 21, start_idx: 105, end_idx: 290)
ann22 = Annotation.create!(anno_body: "Train yourself to let go of everything you fear to lose.", author_id: 22, track_id: 22, start_idx: 105, end_idx: 290)
ann23 = Annotation.create!(anno_body: "When you look at the dark side, careful you must be. For the dark side looks back.", author_id: 23, track_id: 23, start_idx: 105, end_idx: 290)
ann24 = Annotation.create!(anno_body: "When you look at the dark side, careful you must be. For the dark side looks back.", author_id: 24, track_id: 24, start_idx: 105, end_idx: 290)
ann25 = Annotation.create!(anno_body: "Difficult to see. Always in motion is the future …", author_id: 25, track_id: 25, start_idx: 105, end_idx: 290)
ann26 = Annotation.create!(anno_body: "If no mistake have you made, yet losing you are … a different game you should play.", author_id: 26, track_id: 26, start_idx: 105, end_idx: 290)
ann27 = Annotation.create!(anno_body: "Control, control, you must learn control!", author_id: 27, track_id: 27, start_idx: 105, end_idx: 290)
ann28 = Annotation.create!(anno_body: "Do. Or do not. There is no try.", author_id: 28, track_id: 28, start_idx: 105, end_idx: 290)
ann29 = Annotation.create!(anno_body: "Do. Or do not. There is no try.", author_id: 29, track_id: 29, start_idx: 105, end_idx: 290)
