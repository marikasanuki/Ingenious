...
user6 = User.create!(username: 'demouser6', password: 'demopassword6')
user7 = User.create!(username: 'demouser7', password: 'demopassword7')
user8 = User.create!(username: 'demouser8', password: 'demopassword8')
user9 = User.create!(username: 'demouser9', password: 'demopassword9')
user10 = User.create!(username: 'demouser10', password: 'demopassword10')
user11 = User.create!(username: 'demouser11', password: 'demopassword11')
...
ann2 = Annotation.create!(anno_body: "Adventure. Excitement. A Jedi craves not these things.", author_id: 3, track_id: 3)
...
ann5 = Annotation.create!(anno_body: "Once you start down the dark path, forever will it dominate your destiny, consume you it will.", author_id: 6, track_id: 6, start_idx: 105, end_idx: 290)
ann7 = Annotation.create!(anno_body: "Luminous beings are we, not this crude matter.", author_id: 7, track_id: 7, start_idx: 105, end_idx: 290)
ann8 = Annotation.create!(anno_body: "In a dark place we find ourselves, and a little more knowledge lights our way.", author_id: 8, track_id: 8, start_idx: 105, end_idx: 290)
ann9 = Annotation.create!(anno_body: "Patience you must have, my young padawan.", author_id: 9, track_id: 9, start_idx: 105, end_idx: 290)
ann10 = Annotation.create!(anno_body: "A Jedi uses the Force for knowledge and defense, never for attack.", author_id: 10, track_id: 10, start_idx: 105, end_idx: 290)
ann11 = Annotation.create!(anno_body: "Judge me by my size, do you?", author_id: 11, track_id: 11)
ann12 = Annotation.create!(anno_body: "Wars not make one great.", author_id: 12, track_id: 12)
ann13 = Annotation.create!(anno_body: "Clear your mind must be, if you are to find the villains behind this plot.", author_id: 13, track_id: 13)
ann14 = Annotation.create!(anno_body: "Always two there are, no more, no less. A master and an apprentice.", author_id: 14, track_id: 14)
ann15 = Annotation.create!(anno_body: "Always pass on what you have learned.", author_id: 15, track_id: 15)
ann16 = Annotation.create!(anno_body: "Mind what you have learned. Save you it can.", author_id: 16, track_id: 16)
ann17 = Annotation.create!(anno_body: "To answer power with power, the Jedi way this is not.", author_id: 17, track_id: 17)
ann18 = Annotation.create!(anno_body: "In this war, a danger there is, of losing who we are.", author_id: 18, track_id: 18)
ann19 = Annotation.create!(anno_body: "Attachment leads to jealously. The shadow of greed, that is.", author_id: 19, track_id: 19)
ann20 = Annotation.create!(anno_body: "In the end, cowards are those who follow the dark side.", author_id: 20, track_id: 20)
ann21 = Annotation.create!(anno_body: "So certain were you. Go back and closer you must look.", author_id: 21, track_id: 21)
ann22 = Annotation.create!(anno_body: "Train yourself to let go of everything you fear to lose.", author_id: 22, track_id: 22)
ann23 = Annotation.create!(anno_body: "When you look at the dark side, careful you must be. For the dark side looks back.", author_id: 23, track_id: 23)
ann24 = Annotation.create!(anno_body: "When you look at the dark side, careful you must be. For the dark side looks back.", author_id: 24, track_id: 24)
ann25 = Annotation.create!(anno_body: "Difficult to see. Always in motion is the future …", author_id: 25, track_id: 25)
ann26 = Annotation.create!(anno_body: "If no mistake have you made, yet losing you are … a different game you should play.", author_id: 26, track_id: 26)
ann27 = Annotation.create!(anno_body: "Control, control, you must learn control!", author_id: 27, track_id: 27)
ann28 = Annotation.create!(anno_body: "Do. Or do not. There is no try.", author_id: 28, track_id: 28)
ann29 = Annotation.create!(anno_body: "Do. Or do not. There is no try.", author_id: 29, track_id: 29)
ann30 = Annotation.create!(anno_body: "Do. Or do not. There is no try.", author_id: 30, track_id: 30)
ann31 = Annotation.create!(anno_body: "Do. Or do not. There is no try.", author_id: 31, track_id: 31)
ann32 = Annotation.create!(anno_body: "Do. Or do not. There is no try.", author_id: 32, track_id: 32)
ann33 = Annotation.create!(anno_body: "Do. Or do not. There is no try.", author_id: 1, track_id: 1, start_idx: 48, end_idx: 70)    
ann34 = Annotation.create!(anno_body: "Do. Or do not. There is no try.", author_id: 1, track_id: 1, start_idx: 450, end_idx: 679)
